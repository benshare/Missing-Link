...
@objcMembers class LeaderboardOverall: AWSDynamoDBObjectModel, AWSDynamoDBModeling {
    ...
    var _puzzlesToday: NSNumber?
    var _mostPuzzlesInOneDay: NSNumber?
    var _lastDay: String?
    
    
    class func dynamoDBTableName() -> String {
        return "missinglink-mobilehub-2144505807-LeaderboardOverall"
    }
    ...
    override class func jsonKeyPathsByPropertyKey() -> [AnyHashable: Any] {
        return [
               ...
               "_puzzlesToday" : "puzzlesToday",
               "_mostPuzzlesInOneDay" : "mostPuzzlesInOneDay",
               "_lastDay" : "lastDay",
        ]
    }
    
    init(username: String, data: OverallData) {
        super.init()
        _username = username
        ...
        _puzzlesToday = NSNumber(value: data.puzzlesCompleted)
